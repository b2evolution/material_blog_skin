...
// ----------------------------- END OF "Menu" CONTAINER -----------------------------
        ...
        <!-- =================================== START OF MAIN AREA =================================== -->
        <div class="row">
            <div class="content <?php echo ( $Skin->get_setting('layout') == 'single_column' ? 'col-md-12' : 'col-md-9' ); ?>"<?php echo ( $Skin->get_setting('layout') == 'left_sidebar' ? ' style="float:right;"' : '' ); ?>>
